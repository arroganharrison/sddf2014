var appView = Backbone.View.extend({
	...
	*/
    ...
    createLogin: function() {
        var checklogin = $.ajax("/login", {
            "type": "POST",
            "data": {
                "username": $("#username-input").val(),
                "password": $("#password-input").val()
            },
            "picureURL": $("#picture-input").val(),
	...
	*/
    ...
    swipeScreen: function() {
        $.ajax("/hungry", {
            "type": "POST",
            "data": {
                "userID": app.currentUser.attributes.userID,
                "hungry": "false"
            }
        });
    ...
    swipe: function(e) {
        if (!(e.which == 37) && !(e.which == 39)) {
            ...
            $.ajax("/match", {
                ...
                "data": {
                    "userID": app.currentUser.attributes.userID,
                    "matchID": app.people.first().attributes.userID
                }
            });
            app.currentUser.set({
                "matchID": app.people.first().attributes.userID
        ...
        setTimeout(function() {
            ...
            rawMatch.done(function(data) {
                ...
                if (data != "None") {
                    ...
                    app.currentUser.set({
                        "matchID": matchPerson.attributes.userID
                    });
                    $.ajax("/hungry", {
                        "type": "POST",
                        "data": {
	...
	*/
    sendRating1: function() {
        ...
        numratings++;
        app.people.first().set({
            "numratings": numratings
        });
        $.ajax("/rating", {
            "type": "POST",
            "data": {
                "userID": app.people.first().attributes.userID,
                "rating": 1,
                "numratings": numratings
            }
        });
